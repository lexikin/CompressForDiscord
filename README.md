...
- **Videos & animated GIFs** → WebM (VP9 + Opus, two-pass, sized to the limit)
...
bits-per-pixel sane, then runs two-pass libvpx-vp9 and verifies the real file size — retrying
