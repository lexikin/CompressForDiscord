...
- **Videos & animated GIFs** → MP4 (H.264 + AAC, two-pass, sized to the limit)
...
bits-per-pixel sane, then runs two-pass x264 (veryfast — speed over squeeze) and verifies the
